...
parser.add_argument('--rgb-list', default='list/newpath_shanghai-i3d-train-10crop.list', help='list of rgb features ')
parser.add_argument('--test-rgb-list', default='list/newpath_shanghai-i3d-test-10crop.list', help='list of test rgb features ')
